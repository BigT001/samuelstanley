    ...
    <div className="relative min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <nav className="relative z-10 px-6 pt-6 pb-2">
        <div className="max-w-3xl mx-auto">
          <Link href="/?tab=feeds" className="inline-flex items-center gap-2 text-sm text-[var(--text-secondary)] hover:text-[var(--coral)] transition-colors duration-200 group">
      ...
      <article className="relative z-10 max-w-3xl mx-auto px-6 py-10">
        ...
        {/* Hero Image */}
        <BlogImage src={post.coverImage || ''} alt={post.title} category={post.category} />
